<template>
  <div id="auth">
    <button v-show="!login" @click="isshown=true" style="width:100px;height:25px;">Login</button>     
    <div v-show="isshown" id="id01" class="modal form">  
      <div class="modal-content animate">
        ...
        <div class="container">
          ...
          <input style="width: 100%;" v-model="username" placeholder="Enter Username" type="text" name="uname" required><br/>
          <label for="psw"><b>Password</b></label><br/> 
          <input style="width: 100%" v-model="password" placeholder="Enter Password" type="password" name="psw" required><br/>  
          <button @click="checklogin">Login</button><br/>
    ...
    <div v-show="login">
      ...
      <button @click="logout" style="width:100px;height:25px;">Logout</button>
    </div>
  </div>
</template>
